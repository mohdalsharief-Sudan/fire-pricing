...
window.FireAPI = (function () {
  ...
  if (electronMode) {
    ...
    return {
      ...
      clientsExportBridge: () => call("clients_exportBridge"),
      clientsImportBridge: () => call("clients_importBridge"),
      exportApprovedQuote: (payload) => call("quote_exportApproved", payload),
